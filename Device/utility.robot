*** Settings ***
Documentation   Check utility service for ${id}
...
Check Brightness level
    ...
    [Tags]     UC_01
    open application    http://127.0.0.1:4723/wd/hub   platformName=android    platformVersion=10   udid=${id}   systemPort=8201   deviceName=TC57X   appPackage=com.android.settings  appActivity=com.android.settings.homepage.SettingsHomepageActivity   automationName=Uiautomator2
