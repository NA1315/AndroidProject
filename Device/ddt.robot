...
Documentation   Run the DDT application and get diagnostic results/data/report  for ${id}
...
Open DDT Application
    ...
    [Tags]   DA_03
    open application    http://127.0.0.1:4723/wd/hub     platformName=android   platformVersion=10  udid=${id}   systemPort=8201  deviceName=TC57X  orientation=PORTRAIT  appPackage=com.symbol.selfdiagnostics  appActivity=com.symbol.selfdiagnostics.activities.MainActivity  automationName=Uiautomator2
    PORTRAIT
    Sleep  5s
