*** Settings ***
Documentation   Device Configure for ${id1}
...
Open Setting Application
    open application    http://127.0.0.1:4723/wd/hub     platformName=android    platformVersion=10  udid=${id1}    systemPort=8202    deviceName=Device-B  appPackage=com.android.settings  appActivity=com.android.settings.homepage.SettingsHomepageActivity  automationName=Uiautomator2
